        ...
        class Page extends \Idno\Common\Component
        {
            ...
            function post()
            {
                ...
                if (\Idno\Core\Idno::site()->session()->isAPIRequest() || \Idno\Core\Idno::site()->actions()->validateToken('', false)) {
                    ...
                    throw new \Idno\Exceptions\PageException('Invalid token.');
                }
            ...
            function forward($location = '', $exit = true)
            {
                ...
                if (!empty($this->forward)) {
                    ...
                    if (!Entity::isLocalUUID($location)) {
                        throw new \Idno\Exceptions\PageException('Attempted to redirect page to a non local URL.');
                    }
                    */
            ...
            function put()
            {
                ...
                if (\Idno\Core\Idno::site()->actions()->validateToken('', false)) {
                    ...
                    throw new \Idno\Exceptions\PageException('The page you were on timed out.');
                }
