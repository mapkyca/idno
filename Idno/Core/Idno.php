    ...
    namespace Idno\Core {
        ...
        class Idno extends \Idno\Common\Component
        {
            ...
            function init()
            {
                ...
                if (!$this->config->url) throw new \Idno\Exceptions\KnownException('Known was unable to work out your base URL! You might try setting url="http://yourdomain.com/" in your config.ini');
