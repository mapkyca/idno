    ...
    namespace Idno\Core {
        ...
        class TokenProvider extends Component
        {
            ...
            function generateToken($length)
            {
                ...
                if (!$strength) {
                    throw new \Idno\Exceptions\KnownException("Token was generated using an a cryptographically weak algorithm, this probably means your version of OpenSSL is broken or very old.");
                }
